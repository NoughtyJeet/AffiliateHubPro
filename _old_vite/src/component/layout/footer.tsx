        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/category/electronics" className="text-gray-400 hover:text-orange-400 transition-colors">Electronics</Link></li>
              <li><Link to="/category/home-kitchen" className="text-gray-400 hover:text-orange-400 transition-colors">Home & Kitchen</Link></li>
              <li><Link to="/category/health-fitness" className="text-gray-400 hover:text-orange-400 transition-colors">Health & Fitness</Link></li>
              <li><Link to="/products" className="text-gray-400 hover:text-orange-400 transition-colors">All Products</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/blog" className="text-gray-400 hover:text-orange-400 transition-colors">All Articles</Link></li>
              <li><Link to="/blog/category/buying-guides" className="text-gray-400 hover:text-orange-400 transition-colors">Buying Guides</Link></li>
              <li><Link to="/blog/category/tech-guides" className="text-gray-400 hover:text-orange-400 transition-colors">Tech Guides</Link></li>
              <li><Link to="/deals" className="text-gray-400 hover:text-orange-400 transition-colors">Best Deals</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/contact" className="text-gray-400 hover:text-orange-400 transition-colors flex items-center gap-1"><Mail className="w-3 h-3" /> Contact</Link></li>
              <li><Link to="/privacy-policy" className="text-gray-400 hover:text-orange-400 transition-colors">Privacy Policy</Link></li>
              <li><Link to="/disclaimer" className="text-gray-400 hover:text-orange-400 transition-colors">Affiliate Disclaimer</Link></li>
              <li><Link to="/sitemap" className="text-gray-400 hover:text-orange-400 transition-colors">Sitemap</Link></li>
            </ul>
          </div>
        </div>
