...
import { trackAffiliateClick } from '../seo/SEOHead';
...
export function ProductCard({ product, className = '' }: ProductCardProps) {
  ...
  return (
    <div className={`group bg-white rounded-2xl border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden ${className}`}>
      {/* Image */}
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mt-auto pt-3 border-t border-gray-50">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white text-xs font-semibold rounded-lg transition-colors ml-auto"
          >
