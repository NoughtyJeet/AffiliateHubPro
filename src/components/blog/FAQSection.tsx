...
export function FAQSection({ faqs }: FAQSectionProps) {
    ...
    return (
        <div className="mt-16">
            <h2 className="text-3xl font-black text-gray-900 dark:text-zinc-50 mb-10 tracking-tight font-primary uppercase tracking-widest">Frequently Asked Questions</h2>
                ...
                {faqs.map((faq, i) => (
                    <div key={i} className="bg-white dark:bg-zinc-900/50 border border-gray-100 dark:border-zinc-800 rounded-3xl overflow-hidden shadow-sm transition-colors group">
                        <button
                            ...
                            className="w-full flex items-center justify-between p-7 text-left hover:bg-gray-50 dark:hover:bg-zinc-900 transition-all font-medium"
                        >
